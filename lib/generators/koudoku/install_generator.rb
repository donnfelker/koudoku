...
module Koudoku
  class InstallGenerator < Rails::Generators::Base
    ...
    def install
      ...
      generate("model", "subscription stripe_id:string plan_id:integer last_four:string coupon_id:integer card_type:string current_price:float #{subscription_owner_model}_id:integer cancel_at_period_end:boolean current_period_end:datetime")
      ...
      # Add coupons.
      generate("model coupon code:string free_trial_length:string interval:integer amount_off:float percent_off:integer redeem_by:datetime max_redemptions:integer duration:string duration_in_months:integer")
